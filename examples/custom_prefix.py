...
if __name__ == '__main__':
    ...
    print("  python custom_prefix.py myapp")
    print("  python custom_prefix.py myapp --help")
    print("  python custom_prefix.py myapp build -v")
    print("  python custom_prefix.py myapp deploy production -f")
    print("  python custom_prefix.py myapp test unit -c")
    print()
    print("  python custom_prefix.py taskrunner")
    print("  python custom_prefix.py taskrunner lint")
    print()
    print("  python custom_prefix.py minimal")
    print("=" * 70)
    print()
